...
> **Note:** FusionCAM is not limited to this default setup and can fuse any combination of gradient-based and region-based CAM techniques, simply specify the desired gradient CAM in `grad_cam` and the region CAM in `region_cam`.
